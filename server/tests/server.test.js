...
describe("GET /todos/:id", () => {
	...
	it("should not return todo document by other user", done => {
		request(app)
...
describe("DELETE /todos/:id", () => {
	...
	it("should remove todo document by other user", done => {
...
describe("PATCH /todos/:id", () => {
	...
	it("should not update todo document created by other user", done => {
		var hexId = todos[0]._id.toHexString();
		var text = "This should be new text";
...
describe('DELETE /users/me/token', () => {
	...
	it('should delete remove auth token on logout', (done) => {
		request(app)
